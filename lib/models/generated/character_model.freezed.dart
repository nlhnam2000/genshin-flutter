...
mixin _$Character {
  ...
  String get birthdaymmdd => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      affiliation: null == affiliation
          ...
          : affiliation // ignore: cast_nullable_to_non_nullable
              as String,
      birthdaymmdd: null == birthdaymmdd
          ? _value.birthdaymmdd
          : birthdaymmdd // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_Character implements _Character {
  ...
  @override
  String toString() {
    return 'Character(name: $name, fullname: $fullname, title: $title, description: $description, rarity: $rarity, element: $element, substat: $substat, gender: $gender, body: $body, association: $association, region: $region, affiliation: $affiliation, birthdaymmdd: $birthdaymmdd, birthday: $birthday, constellation: $constellation, images: $images)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.birthdaymmdd, birthdaymmdd) ||
                other.birthdaymmdd == birthdaymmdd) &&
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required final String birthdaymmdd,
      required final String birthday,
      required final String constellation,
      required final ImageModel images}) = _$_Character;
